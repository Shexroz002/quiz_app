...
from app.api.v1.quiz.endpoints.pdf_to_quiz import pdf_to_quiz_router
from app.api.v1.quiz.endpoints.question import question_router
...
base_quiz_router.include_router(pdf_to_quiz_router)

base_quiz_router.include_router(question_router)
