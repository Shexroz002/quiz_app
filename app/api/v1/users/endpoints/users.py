...
from app.schemas.account.users import UserListSchema, UpdateUserSchema, UserContactListSchema, UserDetailPatchSchema
...
@users_router.put("/{user_id}/", response_model=UserDetailPatchSchema)
async def update_user(
        user_id: int,
        user_update: UserDetailPatchSchema,
        user_service: UserService = Depends(get_user_service),
